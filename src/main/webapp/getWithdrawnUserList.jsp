...
<%
    ...
    try {
        ...
        String query = "SELECT id, nickname, name, sex, joinDate, withdrawDate FROM lost_user ORDER BY withdrawDate DESC";
        ...
        while (rs.next()) {
            ...
            user.addProperty("withdrawDate", rs.getTimestamp("withdrawDate").toString());
            userArray.add(user);
        }
        ...
        error.addProperty("error", "탈퇴 회원 데이터 로드 중 오류가 발생했습니다: " + e.getMessage());
