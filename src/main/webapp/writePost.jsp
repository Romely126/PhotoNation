    ...
    <script>
        ...
        const templates = {
            market: {
                content: `
<h4><b>📦 상품 정보</b></h4>
<p><b>상품명:</b> [상품명을 입력하세요]</p>
<p><b>가격:</b> [가격을 입력하세요] 원</p>
<p><b>거래방법:</b> [직거래/택배거래/기타]</p>
<p><b>거래지역:</b> [거래 가능한 지역을 입력하세요]</p>
<p><b>상품상태:</b> [새상품/중고-상/중고-중/중고-하]</p>

<hr>

<h4><b>📝 상품 설명</b></h4>
<p>[상품에 대한 자세한 설명을 입력하세요]</p>
<ul>
    <li>구매시기: </li>
    <li>사용기간: </li>
    <li>하자여부: </li>
...
<h4><b>📋 거래 안내</b></h4>
<p><b>연락처:</b> [연락 가능한 방법을 입력하세요]</p>
<p><b>거래시간:</b> [거래 가능한 시간대를 입력하세요]</p>
<p><b>기타사항:</b> [추가로 알려드릴 내용이 있다면 입력하세요]</p>

<hr>

<h4><b>📷 상품 사진</b></h4>
<p style="color: #666; font-size: 14px;">
상품의 실제 사진을 첨부해주세요. 여러 각도에서 촬영한 사진을 올리시면 구매자에게 더 도움이 됩니다.
</p>
<p style="margin-bottom: 20px;"><i>※ 이미지는 위의 '이미지 첨부' 버튼을 이용해서 업로드하세요</i></p>
